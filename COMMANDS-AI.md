...
definition-editor - run definition GUI editor (needs node.js) (help: no)
...
editor - run various GUI tools (needs node.js) (help: yes)
...
environment-editor - run environment GUI editor (needs node.js) (help: no)
...
monitor-editor - run monitor GUI editor (needs node.js) (help: no)
...
patternfile-editor - run patternfile GUI editor (needs node.js) (help: no)
...
sourcetree-editor - run sourcetree GUI editor (needs node.js) (help: no)
...
tool-editor - run tool GUI editor (needs node.js) (help: no)
